...
public class OpenButton extends Button {
    public OpenButton(Stage stage, Component codeEditor, OpenFilesPanel openFilesPanel) {
        super("Open");
    ...
    private void openFile(File selectedFile, Component codeEditor, OpenFilesPanel openFilesPanel) {
        try {
